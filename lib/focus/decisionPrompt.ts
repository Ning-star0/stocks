...
15. 手续费按 max(amount, 10000) * 0.0005 计算。不足 10000 元的交易也要按 10000 元计费，即最低手续费 5 元；买入计划若成交金额低于 ${TRADING_FEE_RULE.minimumFeeBase / 2} 元，通常会被系统视为手续费效率不足并过滤，应建议等待、合并交易或提高现金后再执行。
