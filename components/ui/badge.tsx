...
const badgeVariants = cva(
  "inline-flex items-center whitespace-nowrap rounded-full border px-2 py-0.5 text-xs font-medium shadow-[inset_0_1px_0_hsl(0_0%_100%/0.22)] transition-colors",
  {
    variants: {
      variant: {
