...
export async function buildStockAnalysisContext(
  ...
  const dataScope = {
    ...
    newsCoverage: effectiveNewsEvidenceRefresh ? {
      ...
      sharedTopicKey: effectiveNewsEvidenceRefresh.fetch?.sharedTopicKey ?? null,
      sharedTopicSource: effectiveNewsEvidenceRefresh.fetch?.sharedTopicSource ?? null,
      sharedTopicReused: effectiveNewsEvidenceRefresh.fetch?.sharedTopicReused ?? false,
      industryClassification: effectiveNewsEvidenceRefresh.fetch?.industryClassification,
